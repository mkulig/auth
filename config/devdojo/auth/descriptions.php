...
return [
    'settings' => [
        ...
        'registration_include_phone_field' => 'During registration, include the Phone field.',
        ...
        'login_show_subheadline' => 'Display the subheadline on the login screen.',
        'register_show_subheadline' => 'Display the subheadline on the registration screen.',
        'passwordResetRequest_show_subheadline' => 'Display the subheadline on the password reset request screen.',
        'passwordReset_show_subheadline' => 'Display the subheadline on the password reset screen.',
        'passwordConfirm_show_subheadline' => 'Display the subheadline on the password confirmation screen.',
        'verify_show_subheadline' => 'Display the subheadline on the verification screen.',
        'twoFactorChallenge_show_subheadline_auth' => 'Display the subheadline on the two-factor authentication challenge screen.',
        'twoFactorChallenge_show_subheadline_recovery' => 'Display the subheadline on the two-factor recovery challenge screen.',
        'invite_show_subheadline' => 'Display the subheadline on the invitation screen.',
        'expired_show_subheadline' => 'Display the subheadline on the expired session screen.',
