<nav class="px-4 mt-1">
    <ul role="list" class="space-y-3">
        <x-auth::setup.sidebar-link-item
            pageLink="auth/setup"
            icon="house"
            text="Home"></x-auth::setup.sidebar-link-item>
        <li>
            ...
            <ul role="list" class="mt-2 space-y-1">
                <x-auth::setup.sidebar-link-item
                    ...
                    icon="paint-bucket"
                    text="Appearance"></x-auth::setup.sidebar-link-item>

                <x-auth::setup.sidebar-link-item
                    pageLink="auth/setup/providers"
                    icon="user-circle-plus"
                    text="Social Providers"></x-auth::setup.sidebar-link-item>
                <x-auth::setup.sidebar-link-item
                    pageLink="auth/setup/settings"
                    icon="gear"
                    text="Settings"></x-auth::setup.sidebar-link-item>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul role="list" class="mt-2 space-y-1">
                <x-auth::setup.sidebar-link-item
                    ...
                    icon="github-logo"
                    text="Github Repo"></x-auth::setup.sidebar-link-item>
                <x-auth::setup.sidebar-link-item
                    newTab="true"
                    pageLink="https://devdojo.com/auth/docs"
                    icon="notebook"
                    text="Documentation"></x-auth::setup.sidebar-link-item>
            </ul>
        </li>
    </ul>
